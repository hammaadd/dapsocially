...
Route::middleware(['auth' => 'role:user'])->group(function () {
    ...
    Route::get('login/instagram', 'User\AccountController@instaRedirect')->name('get.token.insta');
    Route::get('login/instagram/callback', 'User\AccountController@instagramProviderCallback')->name('instagram.login.callback');
...
Route::get('login/facebook/check', 'Auth\LoginController@redirectToFacebook')->name('login.facebook');
