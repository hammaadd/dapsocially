...
<main>
    ...
    <nav class="bg-grey-light p-3 rounded font-sans w-full m-4">
        <ol class="list-reset flex text-grey-dark">
            ...
            <li><span class="mx-2">/</span></li>
            <li><a href="{{route('my.venues')}}" class="text-blue-550 font-bold">My Venues</a></li>
            <li><span class="mx-2">/</span></li>
            <li>Edit Venue</li>
        </ol>
    </nav>
    <section class="py-10 max-w-5xl mx-auto">
        <form action="{{route('update.venue',$venue)}}" method="POST" enctype="multipart/form-data" onsubmit="return checkInputBox()">
            @csrf
                    ...
                    <div class="flex flex-wrap overflow-hidden md:-mx-2 lg:-mx-3 xl:-mx-3">
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 md:w-1/2 lg:my-3 lg:px-3 lg:w-1/2 xl:my-3 xl:px-3 xl:w-1/2">
                            <label for="vname">
                                ...
                                <input type="text" name="vname" id="vname" class="input-field" placeholder="Write your venue name" value="{{$venue->venue_name}}">
                            </label>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 md:w-1/2 lg:my-3 lg:px-3 lg:w-1/2 xl:my-3 xl:px-3 xl:w-1/2">
                            <label for="location">
                                ...
                                <input type="text" id="loc_address" name="loc_address" class="input-field" placeholder="California" autocomplete="off" value={{$location->address}}>
                            </label>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 md:w-1/3 lg:my-3 lg:px-3 lg:w-1/3 xl:my-3 xl:px-3 xl:w-1/3">
                            <label for="city">
                                City
                                <input type="text" id="locality" name="locality" class="input-field" placeholder="City" value="{{$location->city}}">
                            </label>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 md:w-1/3 lg:my-3 lg:px-3 lg:w-1/3 xl:my-3 xl:px-3 xl:w-1/3">
                            <label for="state">
                                State
                                <input type="text" id="state" name="state" class="input-field" placeholder="State" value="{{$location->state}}">
                            </label>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 md:w-1/3 lg:my-3 lg:px-3 lg:w-1/3 xl:my-3 xl:px-3 xl:w-1/3">
                            <label for="country">
                                Country
                                <input type="text" id="country" name="country" class="input-field" placeholder="Country" value="{{$location->country}}">
                            </label>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3">
                            <label for="cover">
                                ...
                                <div class="w-full h-60 relative border-gray-200 border bg-gray-200 rounded-md mt-1">
                                    <img src="{{asset('Users/VenueImages/'.$venue->c_image)}}" id="coverImage" class="object-cover w-full rounded-md" alt="">
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3">
                            <label for="description">
                                ...
                                <textarea name="e_descrip" id="e_descrip" rows="3" placeholder="Write briefly about your Event" class="input-field">{{$venue->v_description}}</textarea>
                            </label>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3">
                            <label for="hashtag">
                                ...
                                <input type="text" name="h_tag" id="h_tag" placeholder="#party  #partytime" class="input-field" value="{{$venue->hashtag}}">
                            </label>
                            ...
                            <div class="relative inline-block w-10 mx-2 align-middle select-none pt-1">
                                <input type="checkbox" name="app_htag" id="Blue" class="checked:bg-white outline-none focus:outline-none right-5 checked:right-0 duration-200 ease-in absolute block w-5 h-5 rounded-full bg-white border-4 appearance-none cursor-pointer" @if ($venue->approve_htag)
                                checked
                                @endif>
                        ...
                        <div class="w-full overflow-hidden md:mb-2 md:px-2 md:w-1/2 lg:mb-3 lg:px-3 lg:w-1/2 xl:mb-3 xl:px-3 xl:w-1/2">
                            ...
                            <div class=" flex py-1.5">
                                ...
                                <input type="text" id="fbi" name="inp[]" class="input--field w--52 min-h-40" placeholder="Enter your Public Page id or Username*" value="{{$post->page_name_id}}">
                            </div>
                        ...
                        <div class="w-full overflow-hidden md:mb-2 md:px-2 md:w-1/2 lg:mb-3 lg:px-3 lg:w-1/2 xl:mb-3 xl:px-3 xl:w-1/2">
                            ...
                            <div class=" flex py-1.5">
                                ...
                                <input type="text" id="insi" name="inp[]" class="input--field w--52 min-h-40" placeholder="Enter your Public Page id or Username*" value="{{$post->page_name_id}}">
                            </div>
                            @error('inp') <small class="text-red-600">Please add page name or id</small>@enderror
                        </div>
                        @endif
                        ...
                        <div class="w-full overflow-hidden md:mb-2 md:px-2 md:w-1/2 lg:mb-3 lg:px-3 lg:w-1/2 xl:mb-3 xl:px-3 xl:w-1/2">
                            ...
                            <div class=" flex py-1.5">
                                ...
                                <input type="text" id="twi" name="inp[]" class="input--field w--52 min-h-40" placeholder="Enter your Public Page id or Username*" value="{{$post->page_name_id}}">
                            </div>
                            @error('inp') <small class="text-red-600">Please add page name or id</small>@enderror
                        </div>
                        @endif
                        ...
                        <div class="w-full overflow-hidden md:mb-2 md:px-2 md:w-1/2 lg:mb-3 lg:px-3 lg:w-1/2 xl:mb-3 xl:px-3 xl:w-1/2">
                            ...
                            <div class=" flex py-1.5">
                                ...
                                <input type="text" id="tiki" name="inp[]" class="input--field w--52 min-h-40" placeholder="Enter your Public Page id or Username*" value="{{$post->page_name_id}}">
                            </div>
                            @error('inp') <small class="text-red-600">Please add page name or id</small>@enderror
                        </div>
                        @endif
                        ...
                        <div class="w-full">
                            <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3">
                                <label for="cover">
                                    ...
                                    <div class="w-full h-60 relative border-gray-200 border bg-gray-200 rounded-md mt-1">
                                        <img src="{{asset('Users/VenueImages/'.$venue->wall_bg_image)}}" id="wall_bg" class="object-cover w-full rounded-md" alt="">
                                        <div class="flex flex-wrap overflow-hidden items-center justify-center flex-col absolute top-0 left-0 right-0 h-full">
                                            <img src="{{asset('assets/icons8_image_file_add.png')}}" alt="">
                                            <small class="text-gray-400 pt-2">Drop an image to Upload</small>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3 group" x-data="{isPkg:'Free', message:'{{$payment_details->id}}', isPid:'{{$payment_details->id}}'}">
                            ...
                            <div class="flex flex-wrap overflow-hidden flex-col items-center p-4 shadow-md rounded-xl bg-white" :class="{'bg-blue-450': isPkg === {{$plans->id}}, 'bg-blue-450': isPid == {{$plans->id}} }">
                                ...
                                <hr class="w-3/5 mx-auto border-gray-900 my-3" :class="{'border-white': isPkg === {{$plans->id}}, 'border-white': isPid == {{$plans->id}} }">
                                <p class="text-center" :class="{'text-white': isPkg === {{$plans->id}}, 'text-white': isPid == {{$plans->id}} }">
                                    {{$plans->description}}
                                </p>
                                @if ($plans->price == 0)
                                <p class="text-2xl text-center uppercase my-3 font-medium" :class="{'text-white': isPkg === {{ $plans->id }}, 'text-white': isPid == {{$plans->id}} }">Free</p>
                                @else
                                <p class="text-2xl text-center uppercase my-3 font-medium" :class="{'text-white': isPkg === {{ $plans->id }}, 'text-white': isPid == {{$plans->id}} }">${{ $plans->price }}
                                </p>
                                @endif
                                <p class="bg-transparent text-blue-550 px-4 py-1.5 border-2 border-blue-550 rounded-3xl hover:text-white hover:bg-blue-550 " :class="{' hover:border-white hover:text-white bg-white': isPkg === {{$plans->id}}, 'hover:border-white hover:text-white bg-white': isPid == {{$plans->id}} }" @click="isPkg = {{$plans->id}}, message='{{$plans->id}}', isPid = '{{$plans->id}}' ">Choose</p>
