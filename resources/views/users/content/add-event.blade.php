                    ...
                    <div class="ml-4">
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3">
                            ...
                            <ul class="list-none pt-3">
                                <li class="inline-block mx-2">
                                    <input type="checkbox" class="cb-input hidden" id="cb1" name="h_tags[]" checked>
                        ...
                        <div class="w-full overflow-hidden md:my-2 md:px-2 lg:my-3 lg:px-3 xl:my-3 xl:px-3">
                            <label for="description">
                                ...
                                <textarea name="m_dap_wall" id="" rows="3" placeholder="Write a Message for your Dapsocially Locations Wall*" class="input-field"></textarea>
                            </label>
