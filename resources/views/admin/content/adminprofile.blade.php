                      ...
                      <div class="mx-auto" style="width: 140px;">
                        <div class="d-flex justify-content-center align-items-center rounded" style="height: 140px; background-color: rgb(233, 236, 239);">
                          <form class="form" novalidate="" method="POST" action="{{route('update.profile')}}" enctype="multipart/form-data">
                            @csrf   
                          <img style="color: rgb(166, 168, 170); font: bold 8pt Arial;" class="img-profile rounded-circle" height="150px" width="150px" id="img" name="img" src="{{ asset('admin/profile/'.Auth::user()->image.'') }}" alt="user profile">
