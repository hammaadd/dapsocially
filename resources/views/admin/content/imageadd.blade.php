...
<nav aria-label="breadcrumb" class="main-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Image ad</li>
    </ol>
</nav>
    <div class="col-md-8 col-12">
        <div class="card scard">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal " action="{{ route('add.image.uploads') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-md-9 form-group">
                                    ...
                                    <div class="ml-2 col-sm-6 uppic">
                                        <div id="msg"></div>
                                          ...
                                          @error('img')
                                          <strong class="text-danger">The Image field is required</strong>
                                      @enderror
                                      </div>
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-10 col-9">
                                                <input type="text" id="time" class="form-control" name="title"
                                                    placeholder="Enter Ad title" value="{{ old('title') }}">
                                            </div>
                                        </div>
                                        @error('title')
                                    ...
                                    @enderror
                                        ...
                                        <div class="form-check adds">
                                            <div class="checkbox">
                                                <input type="checkbox" id="checkbox1" class="form-check-input"
                                                    checked name="cat[]" value="Events" >
                                                <label for="checkbox1">Events</label>

                                            </div>
                                            <div class="checkbox">
                                                <input type="checkbox" id="checkbox1" class="form-check-input"
                                                    checked name="cat[]" value="Venues">
                                        ...
                                        @enderror
                                            <div class="checkbox">
                                                <input type="checkbox" id="checkbox1" class="form-check-input"
                                                    checked name="a_type[]" value="Free">
                                                <label for="checkbox1">Free</label>

                                            </div>
                                            <div class="checkbox">
                                                <input type="checkbox" id="checkbox1" class="form-check-input"
                                                    checked name="a_type[]" value="Paid">
